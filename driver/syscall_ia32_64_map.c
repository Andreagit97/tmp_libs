 ...
 * (https://github.com/falcosecurity/syscalls-bumper).") DO NOT EDIT THIS FILE MANUALLY.")
 */
...
const int g_ia32_64_map[SYSCALL_TABLE_SIZE] = {
        ...
        [20] = 39,
        [21] = 165,
        [22] = 166,  // NOTE: syscall umount unmapped on x86_64, forcefully mapped to compatible
                     // syscall. See syscalls-bumper bumpIA32to64Map() call.
        [23] = 105,
        [24] = 102,
        ...
        [138] = 122,
        [139] = 123,
        [140] = 8,  // NOTE: syscall _llseek unmapped on x86_64, forcefully mapped to compatible
                    // syscall. See syscalls-bumper bumpIA32to64Map() call.
        [141] = 78,
        ...
        [187] = 40,
        [190] = 58,
        [191] = 97,  // NOTE: syscall ugetrlimit unmapped on x86_64, forcefully mapped to compatible
                     // syscall. See syscalls-bumper bumpIA32to64Map() call.
        [192] = 9,   // NOTE: syscall mmap2 unmapped on x86_64, forcefully mapped to compatible
                     // syscall. See syscalls-bumper bumpIA32to64Map() call.
        [193] = -1,  // ia32 only: truncate64
        [194] = -1,  // ia32 only: ftruncate64
        [195] = 4,   // NOTE: syscall stat64 unmapped on x86_64, forcefully mapped to compatible
                     // syscall. See syscalls-bumper bumpIA32to64Map() call.
        [196] = 6,   // NOTE: syscall lstat64 unmapped on x86_64, forcefully mapped to compatible
                     // syscall. See syscalls-bumper bumpIA32to64Map() call.
        [197] = 5,   // NOTE: syscall fstat64 unmapped on x86_64, forcefully mapped to compatible
                     // syscall. See syscalls-bumper bumpIA32to64Map() call.
        [198] = -1,  // ia32 only: lchown32
        [199] = 102,  // NOTE: syscall getuid32 unmapped on x86_64, forcefully mapped to compatible
                      // syscall. See syscalls-bumper bumpIA32to64Map() call.
        [200] = 104,  // NOTE: syscall getgid32 unmapped on x86_64, forcefully mapped to compatible
                      // syscall. See syscalls-bumper bumpIA32to64Map() call.
        [201] = 107,  // NOTE: syscall geteuid32 unmapped on x86_64, forcefully mapped to compatible
                      // syscall. See syscalls-bumper bumpIA32to64Map() call.
        [202] = 108,  // NOTE: syscall getegid32 unmapped on x86_64, forcefully mapped to compatible
                      // syscall. See syscalls-bumper bumpIA32to64Map() call.
        ...
        [208] = 117,  // NOTE: syscall setresuid32 unmapped on x86_64, forcefully mapped to
                      // compatible syscall. See syscalls-bumper bumpIA32to64Map() call.
        [209] = 118,  // NOTE: syscall getresuid32 unmapped on x86_64, forcefully mapped to
                      // compatible syscall. See syscalls-bumper bumpIA32to64Map() call.
        [210] = 119,  // NOTE: syscall setresgid32 unmapped on x86_64, forcefully mapped to
                      // compatible syscall. See syscalls-bumper bumpIA32to64Map() call.
        [211] = 120,  // NOTE: syscall getresgid32 unmapped on x86_64, forcefully mapped to
                      // compatible syscall. See syscalls-bumper bumpIA32to64Map() call.
        [212] = -1,   // ia32 only: chown32
        [213] = 105,  // NOTE: syscall setuid32 unmapped on x86_64, forcefully mapped to compatible
                      // syscall. See syscalls-bumper bumpIA32to64Map() call.
        [214] = 106,  // NOTE: syscall setgid32 unmapped on x86_64, forcefully mapped to compatible
                      // syscall. See syscalls-bumper bumpIA32to64Map() call.
        ...
        [219] = 28,
        [220] = 217,
        [221] = 72,  // NOTE: syscall fcntl64 unmapped on x86_64, forcefully mapped to compatible
                     // syscall. See syscalls-bumper bumpIA32to64Map() call.
        [224] = 186,
        [225] = 187,
        [226] = 188,
        ...
        [237] = 199,
        [238] = 200,
        [239] = 40,  // NOTE: syscall sendfile64 unmapped on x86_64, forcefully mapped to compatible
                     // syscall. See syscalls-bumper bumpIA32to64Map() call.
        [240] = 202,
        [241] = 203,
        [242] = 204,
