...
const struct syscall_evt_pair g_syscall_table[SYSCALL_TABLE_SIZE] = {
        ...
        [__NR_brk - SYSCALL_TABLE_ID0] = {UF_USED | UF_ALWAYS_DROP,
                                          ...
                                          PPM_SC_BRK},
        [__NR_read - SYSCALL_TABLE_ID0] = {UF_USED,
                                           PPME_SYSCALL_READ_E,
                                           PPME_SYSCALL_READ_X,
                                           PPM_SC_READ},
        [__NR_write - SYSCALL_TABLE_ID0] = {UF_USED,
        ...
        [__NR_getcwd - SYSCALL_TABLE_ID0] = {UF_USED | UF_ALWAYS_DROP,
                                             ...
                                             PPM_SC_GETCWD},
#ifdef __NR_capset
        [__NR_capset - SYSCALL_TABLE_ID0] = {UF_USED,
        ...
        [__NR_fchdir - SYSCALL_TABLE_ID0] = {UF_USED | UF_NEVER_DROP,
                                             ...
                                             PPM_SC_FCHDIR},
#ifdef __NR_mkdir
        [__NR_mkdir - SYSCALL_TABLE_ID0] = {UF_USED,
                                            PPME_SYSCALL_MKDIR_2_E,
                                            PPME_SYSCALL_MKDIR_2_X,
                                            PPM_SC_MKDIR},
#endif
#ifdef __NR_rmdir
        [__NR_rmdir - SYSCALL_TABLE_ID0] = {UF_USED,
        ...
        [__NR_openat - SYSCALL_TABLE_ID0] = {UF_USED | UF_NEVER_DROP,
                                             ...
                                             PPM_SC_OPENAT},
        [__NR_mkdirat - SYSCALL_TABLE_ID0] = {UF_USED,
                                              PPME_SYSCALL_MKDIRAT_E,
                                              PPME_SYSCALL_MKDIRAT_X,
                                              PPM_SC_MKDIRAT},
#ifdef __NR_link
        [__NR_link - SYSCALL_TABLE_ID0] = {UF_USED,
                                           PPME_SYSCALL_LINK_2_E,
                                           PPME_SYSCALL_LINK_2_X,
                                           PPM_SC_LINK},
#endif
        [__NR_linkat - SYSCALL_TABLE_ID0] = {UF_USED,
                                             PPME_SYSCALL_LINKAT_2_E,
                                             PPME_SYSCALL_LINKAT_2_X,
                                             PPM_SC_LINKAT},
#ifdef __NR_unlink
        [__NR_unlink - SYSCALL_TABLE_ID0] = {UF_USED,
        ...
        [__NR_unlinkat - SYSCALL_TABLE_ID0] = {UF_USED,
                                               ...
                                               PPM_SC_UNLINKAT},
        [__NR_pread64 - SYSCALL_TABLE_ID0] = {UF_USED,
                                              PPME_SYSCALL_PREAD_E,
                                              PPME_SYSCALL_PREAD_X,
                                              PPM_SC_PREAD64},
        [__NR_pwrite64 - SYSCALL_TABLE_ID0] = {UF_USED,
                                               PPME_SYSCALL_PWRITE_E,
                                               PPME_SYSCALL_PWRITE_X,
                                               PPM_SC_PWRITE64},
        [__NR_readv - SYSCALL_TABLE_ID0] = {UF_USED,
                                            PPME_SYSCALL_READV_E,
                                            PPME_SYSCALL_READV_X,
                                            PPM_SC_READV},
        [__NR_writev - SYSCALL_TABLE_ID0] = {UF_USED,
                                             PPME_SYSCALL_WRITEV_E,
                                             PPME_SYSCALL_WRITEV_X,
                                             PPM_SC_WRITEV},
        [__NR_preadv - SYSCALL_TABLE_ID0] = {UF_USED,
                                             PPME_SYSCALL_PREADV_E,
                                             PPME_SYSCALL_PREADV_X,
                                             PPM_SC_PREADV},
        [__NR_pwritev - SYSCALL_TABLE_ID0] = {UF_USED,
        ...
        [__NR_signalfd4 - SYSCALL_TABLE_ID0] = {UF_USED | UF_NEVER_DROP,
                                                ...
                                                PPM_SC_SIGNALFD4},
#endif
        [__NR_kill - SYSCALL_TABLE_ID0] = {UF_USED,
                                           PPME_SYSCALL_KILL_E,
                                           PPME_SYSCALL_KILL_X,
                                           PPM_SC_KILL},
        [__NR_tkill - SYSCALL_TABLE_ID0] = {UF_USED,
                                            PPME_SYSCALL_TKILL_E,
                                            PPME_SYSCALL_TKILL_X,
                                            PPM_SC_TKILL},
        [__NR_tgkill - SYSCALL_TABLE_ID0] = {UF_USED,
        ...
        [__NR_nanosleep - SYSCALL_TABLE_ID0] = {UF_USED | UF_ALWAYS_DROP,
                                                ...
                                                PPM_SC_NANOSLEEP},
        [__NR_timerfd_create - SYSCALL_TABLE_ID0] = {UF_USED | UF_NEVER_DROP,
        ...
        [__NR_inotify_init1 - SYSCALL_TABLE_ID0] = {UF_USED | UF_NEVER_DROP,
                                                    PPME_SYSCALL_INOTIFY_INIT1_E,
                                                    PPME_SYSCALL_INOTIFY_INIT1_X,
                                                    PPM_SC_INOTIFY_INIT1},
#endif
        [__NR_fchmodat - SYSCALL_TABLE_ID0] = {UF_USED,
                                               PPME_SYSCALL_FCHMODAT_E,
                                               PPME_SYSCALL_FCHMODAT_X,
                                               PPM_SC_FCHMODAT},
        [__NR_fchmod - SYSCALL_TABLE_ID0] = {UF_USED,
                                             PPME_SYSCALL_FCHMOD_E,
                                             PPME_SYSCALL_FCHMOD_X,
                                             PPM_SC_FCHMOD},
#ifdef __NR_getrlimit
        [__NR_getrlimit - SYSCALL_TABLE_ID0] = {UF_USED,
        ...
        [__NR_ugetrlimit - SYSCALL_TABLE_ID0] = {UF_USED,
                                                 PPME_SYSCALL_GETRLIMIT_E,
                                                 PPME_SYSCALL_GETRLIMIT_X,
                                                 PPM_SC_UGETRLIMIT},
#endif
        [__NR_fcntl - SYSCALL_TABLE_ID0] = {UF_USED,
                                            PPME_SYSCALL_FCNTL_E,
                                            PPME_SYSCALL_FCNTL_X,
                                            PPM_SC_FCNTL},
#ifdef __NR_fcntl64
        [__NR_fcntl64 - SYSCALL_TABLE_ID0] = {UF_USED,
                                              PPME_SYSCALL_FCNTL_E,
                                              PPME_SYSCALL_FCNTL_X,
                                              PPM_SC_FCNTL64},
#endif
#ifdef __NR_chmod
        [__NR_chmod - SYSCALL_TABLE_ID0] = {UF_USED,
                                            PPME_SYSCALL_CHMOD_E,
                                            PPME_SYSCALL_CHMOD_X,
                                            PPM_SC_CHMOD},
#endif
        [__NR_mount - SYSCALL_TABLE_ID0] = {UF_USED,
                                            PPME_SYSCALL_MOUNT_E,
                                            PPME_SYSCALL_MOUNT_X,
                                            PPM_SC_MOUNT},
#ifdef __NR_umount2
        [__NR_umount2 - SYSCALL_TABLE_ID0] = {UF_USED,
                                              PPME_SYSCALL_UMOUNT2_E,
                                              PPME_SYSCALL_UMOUNT2_X,
                                              PPM_SC_UMOUNT2},
#endif
        [__NR_ptrace - SYSCALL_TABLE_ID0] = {UF_USED,
...
#endif
#ifdef __NR_connect
        [__NR_connect - SYSCALL_TABLE_ID0] = {UF_USED,
                                              PPME_SOCKET_CONNECT_E,
                                              PPME_SOCKET_CONNECT_X,
                                              PPM_SC_CONNECT},
#endif
#ifdef __NR_listen
        [__NR_listen - SYSCALL_TABLE_ID0] = {UF_USED,
                                             PPME_SOCKET_LISTEN_E,
                                             PPME_SOCKET_LISTEN_X,
                                             PPM_SC_LISTEN},
#endif
#ifdef __NR_accept
        [__NR_accept - SYSCALL_TABLE_ID0] = {UF_USED,
...
#endif
#ifdef __NR_sendto
        [__NR_sendto - SYSCALL_TABLE_ID0] = {UF_USED,
                                             PPME_SOCKET_SENDTO_E,
                                             PPME_SOCKET_SENDTO_X,
                                             PPM_SC_SENDTO},
#endif
#ifdef __NR_recvfrom
        [__NR_recvfrom - SYSCALL_TABLE_ID0] = {UF_USED,
                                               PPME_SOCKET_RECVFROM_E,
                                               PPME_SOCKET_RECVFROM_X,
                                               PPM_SC_RECVFROM},
#endif
#ifdef __NR_shutdown
        [__NR_shutdown - SYSCALL_TABLE_ID0] = {UF_USED,
                                               PPME_SOCKET_SHUTDOWN_E,
                                               PPME_SOCKET_SHUTDOWN_X,
                                               PPM_SC_SHUTDOWN},
#endif
#ifdef __NR_setsockopt
        [__NR_setsockopt - SYSCALL_TABLE_ID0] = {UF_USED,
...
#endif
#ifdef __NR_sendmsg
        [__NR_sendmsg - SYSCALL_TABLE_ID0] = {UF_USED,
                                              PPME_SOCKET_SENDMSG_E,
                                              PPME_SOCKET_SENDMSG_X,
                                              PPM_SC_SENDMSG},
#endif
#ifdef __NR_accept4
        [__NR_accept4 - SYSCALL_TABLE_ID0] = {UF_USED,
                                              PPME_SOCKET_ACCEPT4_6_E,
                                              PPME_SOCKET_ACCEPT4_6_X,
                                              PPM_SC_ACCEPT4},
#endif
#ifdef __NR_sendmmsg
        [__NR_sendmmsg - SYSCALL_TABLE_ID0] = {UF_USED,
                                               PPME_SOCKET_SENDMMSG_E,
                                               PPME_SOCKET_SENDMMSG_X,
                                               PPM_SC_SENDMMSG},
#endif
#ifdef __NR_recvmsg
        [__NR_recvmsg - SYSCALL_TABLE_ID0] = {UF_USED,
                                              PPME_SOCKET_RECVMSG_E,
                                              PPME_SOCKET_RECVMSG_X,
                                              PPM_SC_RECVMSG},
#endif
#ifdef __NR_recvmmsg
        [__NR_recvmmsg - SYSCALL_TABLE_ID0] = {UF_USED,
...
#endif
#ifdef __NR_mmap
        [__NR_mmap - SYSCALL_TABLE_ID0] = {UF_USED,
                                           PPME_SYSCALL_MMAP_E,
                                           PPME_SYSCALL_MMAP_X,
                                           PPM_SC_MMAP},
#endif
#ifdef __NR_mmap2
        [__NR_mmap2 - SYSCALL_TABLE_ID0] = {UF_USED,
        ...
        [__NR_munmap - SYSCALL_TABLE_ID0] = {UF_USED | UF_ALWAYS_DROP,
                                             ...
                                             PPM_SC_MUNMAP},
        [__NR_splice - SYSCALL_TABLE_ID0] = {UF_USED,
                                             PPME_SYSCALL_SPLICE_E,
                                             PPME_SYSCALL_SPLICE_X,
                                             PPM_SC_SPLICE},

#ifdef __NR_rename
        [__NR_rename - SYSCALL_TABLE_ID0] = {UF_USED,
                                             PPME_SYSCALL_RENAME_E,
                                             PPME_SYSCALL_RENAME_X,
                                             PPM_SC_RENAME},
#endif
#ifdef __NR_renameat
        [__NR_renameat - SYSCALL_TABLE_ID0] = {UF_USED,
                                               PPME_SYSCALL_RENAMEAT_E,
                                               PPME_SYSCALL_RENAMEAT_X,
                                               PPM_SC_RENAMEAT},
#endif
#ifdef __NR_symlink
        [__NR_symlink - SYSCALL_TABLE_ID0] = {UF_USED,
        ...
        [__NR_symlinkat - SYSCALL_TABLE_ID0] = {UF_USED,
                                                ...
                                                PPM_SC_SYMLINKAT},
        [__NR_sendfile - SYSCALL_TABLE_ID0] = {UF_USED,
...
#endif
#ifdef __NR_quotactl
        [__NR_quotactl - SYSCALL_TABLE_ID0] = {UF_USED,
...
#endif
#ifdef __NR_setuid
        [__NR_setuid - SYSCALL_TABLE_ID0] = {UF_USED,
                                             PPME_SYSCALL_SETUID_E,
                                             PPME_SYSCALL_SETUID_X,
                                             PPM_SC_SETUID},
#endif
#ifdef __NR_setuid32
        [__NR_setuid32 - SYSCALL_TABLE_ID0] = {UF_USED,
                                               PPME_SYSCALL_SETUID_E,
                                               PPME_SYSCALL_SETUID_X,
                                               PPM_SC_SETUID32},
#endif
#ifdef __NR_setgid
        [__NR_setgid - SYSCALL_TABLE_ID0] = {UF_USED,
                                             PPME_SYSCALL_SETGID_E,
                                             PPME_SYSCALL_SETGID_X,
                                             PPM_SC_SETGID},
#endif
#ifdef __NR_setgid32
        [__NR_setgid32 - SYSCALL_TABLE_ID0] = {UF_USED,
                                               PPME_SYSCALL_SETGID_E,
                                               PPME_SYSCALL_SETGID_X,
                                               PPM_SC_SETGID32},
#endif
#ifdef __NR_getuid
        [__NR_getuid - SYSCALL_TABLE_ID0] = {UF_USED,
                                             PPME_SYSCALL_GETUID_E,
                                             PPME_SYSCALL_GETUID_X,
                                             PPM_SC_GETUID},
#endif
#ifdef __NR_getuid32
        [__NR_getuid32 - SYSCALL_TABLE_ID0] = {UF_USED,
                                               PPME_SYSCALL_GETUID_E,
                                               PPME_SYSCALL_GETUID_X,
                                               PPM_SC_GETUID32},
#endif
#ifdef __NR_geteuid
        [__NR_geteuid - SYSCALL_TABLE_ID0] = {UF_USED,
                                              PPME_SYSCALL_GETEUID_E,
                                              PPME_SYSCALL_GETEUID_X,
                                              PPM_SC_GETEUID},
#endif
#ifdef __NR_geteuid32
        [__NR_geteuid32 - SYSCALL_TABLE_ID0] = {UF_USED,
                                                PPME_SYSCALL_GETEUID_E,
                                                PPME_SYSCALL_GETEUID_X,
                                                PPM_SC_GETEUID32},
#endif
#ifdef __NR_getgid
        [__NR_getgid - SYSCALL_TABLE_ID0] = {UF_USED,
                                             PPME_SYSCALL_GETGID_E,
                                             PPME_SYSCALL_GETGID_X,
                                             PPM_SC_GETGID},
#endif
#ifdef __NR_getgid32
        [__NR_getgid32 - SYSCALL_TABLE_ID0] = {UF_USED,
                                               PPME_SYSCALL_GETGID_E,
                                               PPME_SYSCALL_GETGID_X,
                                               PPM_SC_GETGID32},
#endif
#ifdef __NR_getegid
        [__NR_getegid - SYSCALL_TABLE_ID0] = {UF_USED,
                                              PPME_SYSCALL_GETEGID_E,
                                              PPME_SYSCALL_GETEGID_X,
                                              PPM_SC_GETEGID},
#endif
#ifdef __NR_getegid32
        [__NR_getegid32 - SYSCALL_TABLE_ID0] = {UF_USED,
                                                PPME_SYSCALL_GETEGID_E,
                                                PPME_SYSCALL_GETEGID_X,
                                                PPM_SC_GETEGID32},
#endif
        ...
        [__NR_getdents64 - SYSCALL_TABLE_ID0] = {UF_USED | UF_ALWAYS_DROP,
                                                 ...
                                                 PPM_SC_GETDENTS64},
#ifdef __NR_setns
        [__NR_setns - SYSCALL_TABLE_ID0] = {UF_USED,
        ...
        [__NR_chroot - SYSCALL_TABLE_ID0] = {UF_USED | UF_NEVER_DROP,
                                             ...
                                             PPM_SC_CHROOT},
#endif
        [__NR_setsid - SYSCALL_TABLE_ID0] = {UF_USED,
        ...
        [__NR_setpgid - SYSCALL_TABLE_ID0] = {UF_USED | UF_ALWAYS_DROP,
                                              ...
                                              PPM_SC_SETPGID},
#ifdef __NR_bpf
        [__NR_bpf - SYSCALL_TABLE_ID0] = {UF_USED,
                                          PPME_SYSCALL_BPF_2_E,
                                          PPME_SYSCALL_BPF_2_X,
                                          PPM_SC_BPF},
#endif
#ifdef __NR_seccomp
        [__NR_seccomp - SYSCALL_TABLE_ID0] = {UF_USED,
...
#endif
#ifdef __NR_openat2
        [__NR_openat2 - SYSCALL_TABLE_ID0] = {UF_USED,
...
#endif
#ifdef __NR_mprotect
        [__NR_mprotect - SYSCALL_TABLE_ID0] = {UF_USED,
        ...
        [__NR_sched_get_priority_max -
                SYSCALL_TABLE_ID0] = {.ppm_sc = PPM_SC_SCHED_GET_PRIORITY_MAX},
        [__NR_sched_get_priority_min -
                SYSCALL_TABLE_ID0] = {.ppm_sc = PPM_SC_SCHED_GET_PRIORITY_MIN},
...
#ifdef __NR_fchown
        [__NR_fchown - SYSCALL_TABLE_ID0] = {UF_USED,
                                             PPME_SYSCALL_FCHOWN_E,
                                             PPME_SYSCALL_FCHOWN_X,
                                             PPM_SC_FCHOWN},
#endif
#ifdef __NR_chown
        [__NR_chown - SYSCALL_TABLE_ID0] = {UF_USED,
...
#ifdef __NR_fchownat
        [__NR_fchownat - SYSCALL_TABLE_ID0] = {UF_USED,
        ...
        [__NR_landlock_restrict_self -
                SYSCALL_TABLE_ID0] = {.ppm_sc = PPM_SC_LANDLOCK_RESTRICT_SELF},
#endif
        ...
        [__NR_set_mempolicy_home_node -
                SYSCALL_TABLE_ID0] = {.ppm_sc = PPM_SC_SET_MEMPOLICY_HOME_NODE},
#endif
...
#endif
#ifdef __NR_lchown
        [__NR_lchown - SYSCALL_TABLE_ID0] = {UF_USED,
